%% Set file path
imageFolder = "F:\Rhys\MATLAB Workspace\Probe_20\Scans\Probe20_ExpNew0_SO31_121_20260508_12h09m54s\";

%% Input manually recorded distances
Stage_Window = 27.245;
Layer_Window = 21.973;
Sample_Window =22.125;
...
Image_Contact_Points = [18.93;18.93;18.93;19.97;19.97;19.97;21.01;21.01;21.01;22.05;22.05;22.05];
...
exportgraphics(gcf, 'Fig3d.pdf', 'ContentType', 'vector');
...
%exportgraphics(gcf, 'Fig1f.tif', 'Resolution', 600)
set(gcf, 'Renderer', 'painters');
exportgraphics(gcf, 'Fig3e.pdf', 'ContentType', 'vector');
...
%exportgraphics(gcf, 'Fig1f.tif', 'Resolution', 600)
set(gcf, 'Renderer', 'painters');
exportgraphics(gcf, 'Fig3f.pdf', 'ContentType', 'vector');
...
%%
createfigure(Eng_Sample_Strain_Im{4})
%%
